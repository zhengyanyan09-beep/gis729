  ...
  <div v-else class="shell" :class="{capacityMode:(page==='fleet'&&role===ROLE.DISPATCH)||(page==='architecture'&&role===ROLE.OPERATOR)}">
    ...
    <main>
      <section class="map-wrap" :class="{mode3d:mapMode==='3d',flightContext:page==='flight'}"><div id="map"></div><canvas v-show="windCanvasVisible && !capacityPage" ref="windCanvas" class="wind-particles"></canvas>
        ...
        <div class="legend glass"><span><i class="blue">✚</i>普通医院</span><span><i class="orange">✚</i>需求医院</span><span><i class="purple">✚</i>供给医院</span><span><i class="red">♥</i>血站</span><span><i class="green">H</i>无人机中心</span><span><i class="route reposition"></i>调机</span><span><i class="route delivery"></i>载货</span><span><i class="route returning"></i>返航</span></div>
